...
var file_einride_iam_v1_caller_proto_goTypes = []any{
...
func file_einride_iam_v1_caller_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_iam_v1_caller_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Caller); i {
			case 0:
				return &v.state
			case 1:
		...
		file_einride_iam_v1_caller_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_caller_proto_msgTypes[3].Exporter = func(v any, i int) any {

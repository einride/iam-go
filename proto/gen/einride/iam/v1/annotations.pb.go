...
func (x *PredefinedRoles) GetRole() []*adminpb.Role {
	if x != nil {
		return x.Role
	}
	return nil
...
var file_einride_iam_v1_annotations_proto_goTypes = []any{
	...
	(*adminpb.Role)(nil),                              // 6: google.iam.admin.v1.Role
...
func file_einride_iam_v1_annotations_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_einride_iam_v1_annotations_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_annotations_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_annotations_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_annotations_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_annotations_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_einride_iam_v1_annotations_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_einride_iam_v1_annotations_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_einride_iam_v1_annotations_proto_msgTypes[4].OneofWrappers = []any{
